        ...
        **kwargs,
        ...
        for i in range(len(pred_embeddings)):
            if self.vision_tower_for_mask:
                sparse_embeddings, dense_embeddings = self.model.prompt_encoder(points=None, boxes=None,masks=None,text_embeds=pred_embeddings[i],) #sparse_embeddings:N, Lev, 25
